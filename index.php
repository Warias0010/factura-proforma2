...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title>Factura proforma super Gangas cony - <?php echo $rw['nombre_comercial'];?></title>
       ...
       <form class="form-horizontal" role="form" id="datos_presupuesto" method="post">
        <div id="print-area">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4">
                  <a href="https://www.google.com/" target="_blank">  <img src="assets/img/logo.png" alt="Logo sistemas web" /></a>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4">
